...
public class BasicTypeServiceTest {
	...
	private Class<String> clazz = String.class;
	private Serializable serializable = new String();
	...
	public void testPostgresql() {
		PostgresqlBasicTypeEntity entity = generatePostgresqlBasicTypeEntity();
		entity = service.saveWithPostgresql(entity);
		Optional<PostgresqlBasicTypeEntity> optionalEntity = service.findByIdWithPostgresql(entity.getId());
		Assert.assertTrue(optionalEntity.isPresent());
	}

	@Test
	public void testMysql() {
//		MysqlBasicTypeEntity entity = generatePostgresqlBasicTypeEntity();
//		service.saveWithMysql(entity);
//		PostgresqlBasicTypeEntity returnEntiyt = service.findByIdWithMysql(id)
//		Assert.assertTrue(entities.size() > 0)
	}

	private PostgresqlBasicTypeEntity generatePostgresqlBasicTypeEntity() {
		PostgresqlBasicTypeEntity entity = new PostgresqlBasicTypeEntity();
